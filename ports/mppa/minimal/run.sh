...
OPTS=':jumbo:verbose:hashpolicy=[P0{@12/0x3=0x800}{@23/0x1=6}{@26#0xff}{@34#0xf}][P1{@12/0x3=0x800}{@23/0x1=17}{@26#0xff}{@34#0xf}][P2{@12/0x3=0x800}{@26#0xff}][{@0#0x3f}]'
CLUSTERS=16
...
exec "$K1_TOOLCHAIN_DIR/bin/k1-jtag-runner" --progress --exec-file=IODDR0:"$FIRMWARE" --exec-file=IODDR1:"$FIRMWARE"$(for ((i=0;i<CLUSTERS;i++));do echo " --exec-file=Cluster$i:echop";done) -- echop -d -f "$IFACE$OPTS" -i "${NET}.2" -g "${NET}.1"
